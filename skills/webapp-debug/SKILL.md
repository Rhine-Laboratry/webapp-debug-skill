...
7. `scripts/bootstrap_playwright_project.py --dry-run` でPlaywright生成先のskeleton計画を確認する。現時点ではPlaywright Scenario生成器は未実装なので、生成済みとして扱わない。
