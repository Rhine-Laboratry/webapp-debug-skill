...
- Known limitations still list dynamic browser discovery, Test Runs/Defects Sheets apply, JavaScript parsing, Playwright artifact collection/status classification, Drive API sharing/deletion, and binary artifact PII redaction as unimplemented.
